...
template <>
void sun::util::update_struct_member_field<y, int, &y::m1> (y* const obj, y const* const value) {
    obj->m1 = value->m1;
    obj->m2 = value->m2;
}

template <>
void sun::util::update_struct_member_field<y, int, &y::m3> (y* const obj, y const* const value) {
    obj->m3 = value->m3;
    obj->m4 = value->m4;
}
